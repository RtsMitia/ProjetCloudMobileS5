...
function Login() {
  ...
  const handleDemoLogin = (role) => {
    const demoCredentials = {
      admin: { email: "admin@lalana.mg", password: "admin123" },
      entreprise: { email: "entreprise@voirie.mg", password: "entreprise123" },
      citoyen: { email: "citoyen@example.mg", password: "citoyen123" },
    };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-emerald-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Plateforme de signalement et gestion des problèmes routiers
        </p>
      </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">Accès démo</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
              <button
                ...
                className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200"
              >
                <UserIcon className="h-5 w-5 text-blue-600 mr-2" />
                Admin
              </button>
              <button
                onClick={() => handleDemoLogin("entreprise")}
                className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200"
              >
                <BuildingOffice2Icon className="h-5 w-5 text-emerald-600 mr-2" />
                Entreprise
              </button>
              <button
                onClick={() => handleDemoLogin("citoyen")}
                className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200"
              >
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    Cette plateforme utilise des protocoles de sécurité avancés pour protéger vos données.
                  </p>
                </div>
              </div>
            </div>
